...
function BuyersGuide() {
  ...
  const faqs = [
    ...
    { q: 'What closing costs should I expect as a buyer?', a: 'Closing costs typically run 2%–5% of the purchase price and cover items like lender fees, title insurance, escrow, appraisal, recording fees, and prepaid property taxes and homeowners insurance. Your lender will provide a Loan Estimate within 3 business days of applying so you can see the full breakdown ahead of time. Some sellers may also agree to cover a portion of closing costs as part of your offer.' },
    { q: 'How important is my credit score when buying a home?', a: 'Your credit score directly affects whether you qualify for a mortgage, what programs are available, and the interest rate you receive — even a 20-point swing can mean thousands over the life of the loan. Most conventional lenders look for a 620+ score, while FHA loans can go as low as 580. Before house-hunting, pull your report, dispute any errors, pay down revolving balances, and avoid opening new credit lines.' },
  ];
          ...
          <div className="mx-auto flex flex-1 items-center px-4 sm:px-6 lg:px-[40px]" style={{ maxWidth: '1400px', width: '100%' }}>
            <div className="w-full max-w-[640px]">
              ...
              <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3">
                <Link href="/properties" className="inline-flex items-center justify-center gap-2 rounded-full text-white transition-opacity hover:opacity-90" style={{ backgroundColor: '#3355FF', height: '46px', paddingLeft: '26px', paddingRight: '26px', fontSize: '14px', fontWeight: 600 }}>Search Homes <ArrowRight className="w-5 h-5" /></Link>
              </div>
            </div>
          </div>
        </div>
