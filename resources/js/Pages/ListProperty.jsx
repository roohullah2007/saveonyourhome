...
function ListProperty() {
  ...
  return (
    <>
      ...
      {/* Page header (lives inside the dashboard layout) */}
      <div className="mb-6">
        <h1 className="text-2xl md:text-3xl font-bold text-[#111] tracking-tight">List your property</h1>
        <p className="text-sm md:text-base text-gray-600 mt-1">
          Fill out the form below to create your free listing — you can be live in a matter of minutes.
        </p>
      </div>
...
// Render inside the seller's dashboard layout (with sidebar) so creating
// a listing feels like part of the seller workspace, not a marketing page.
ListProperty.layout = (page) => <UserDashboardLayout title="List your property">{page}</UserDashboardLayout>;
