        ...
        <UserDashboardLayout title="Saved Searches">
            ...
            {savedSearches.length === 0 ? (
                ...
                <ul className="space-y-3">
                    {savedSearches.map((s) => (
                        <li key={s.id} className="bg-white rounded-2xl border border-gray-100 p-5 flex items-center gap-4 shadow-sm">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="text-xs text-gray-400 mt-0.5 flex items-center gap-1">
                                    <Clock className="w-3 h-3" /> saved {formatDate(s.created_at)}
                                </div>
                            </div>
                            <Link
