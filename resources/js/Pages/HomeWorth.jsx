  ...
  return (
    <>
          ...
          <div className="mx-auto flex flex-1 items-center px-4 sm:px-6 lg:px-[40px]" style={{ maxWidth: '1400px', width: '100%' }}>
            <div className="w-full max-w-[600px]">
              <div className="mb-6 inline-flex items-center gap-2 rounded-full px-5 py-2.5" style={{ border: '1px solid rgba(156,163,175,0.25)', background: 'rgba(255,255,255,0.06)', backdropFilter: 'blur(20px)', boxShadow: 'rgba(0,0,0,0.12) 0px 8px 32px' }}>
                ...
                <span style={{ fontSize: '13px', fontWeight: 600, letterSpacing: '1.5px', color: 'rgba(255,255,255,0.9)' }}>HOME VALUATION</span>
              </div>
      ...
      <section style={{ backgroundColor: 'rgb(249,250,251)' }}>
        <div className="mx-auto px-4 sm:px-6 lg:px-[40px] py-12 md:py-20" style={{ maxWidth: '1400px' }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
              <div className="mb-4">
                <span style={{ fontWeight: 600, fontSize: '13px', letterSpacing: '2px', color: 'rgb(100,100,100)' }}>AI-POWERED TOOL</span>
              </div>
              ...
              <p className="text-[15px] leading-[1.75] mb-6" style={{ color: 'rgb(100,100,100)' }}>
            ...
            <div className="rounded-2xl border border-gray-200/60 p-8" style={{ background: 'rgba(255,255,255,0.65)', backdropFilter: 'blur(16px)', boxShadow: 'rgba(0,0,0,0.06) 0px 4px 24px, rgba(255,255,255,0.8) 0px 1px 0px inset' }}>
              <h3 className="text-[22px] sm:text-[26px] mb-6" style={{ fontWeight: 700, color: 'rgb(26,24,22)' }}>
                What's your home worth?
              </h3>
              <div className="space-y-4">
                <div>
                  <label style={{ display: 'block', fontSize: '13px', fontWeight: 500, color: 'rgb(107,114,128)', marginBottom: '6px' }}>Property Address</label>
                  <input
                    type="text"
                ...
                <button className="inline-flex items-center justify-center gap-2 rounded-full text-white transition-opacity hover:opacity-90 w-full" style={{ backgroundColor: 'rgb(26,24,22)', height: '48px', fontSize: '15px', fontWeight: 600 }}>
                  Check <ArrowRight className="w-4 h-4" />
                </button>
              </div>
              <p className="mt-4 text-center" style={{ fontSize: '13px', color: 'rgb(156,163,175)' }}>
                Powered by Homebot
              </p>
            </div>
          </div>
      ...
      <section style={{ backgroundColor: 'rgb(255,255,255)' }}>
        <div className="mx-auto px-4 sm:px-6 lg:px-[40px] py-12 md:py-20" style={{ maxWidth: '1400px' }}>
          <div className="mb-4">
            <span style={{ fontWeight: 600, fontSize: '13px', letterSpacing: '2px', color: 'rgb(100,100,100)' }}>FREQUENTLY ASKED QUESTIONS</span>
          </div>
      ...
      <section style={{ backgroundColor: 'rgb(26,24,22)' }}>
        <div className="mx-auto px-4 sm:px-6 lg:px-[40px] py-12 md:py-20" style={{ maxWidth: '1400px' }}>
          <div className="max-w-2xl mx-auto text-center mb-12">
            ...
            <p style={{ fontSize: '15px', lineHeight: '26px', color: 'rgba(255,255,255,0.6)' }}>
          ...
          <div className="max-w-4xl mx-auto rounded-2xl border border-white/10 p-8" style={{ background: 'rgba(255,255,255,0.05)', backdropFilter: 'blur(16px)' }}>
            {(submitted || flash?.success) && (
              <div className="mb-6 rounded-xl p-4 flex items-center gap-3" style={{ backgroundColor: 'rgba(240,253,244,0.1)', border: '1px solid rgba(187,247,208,0.3)' }}>
                ...
                <p style={{ fontSize: '14px', fontWeight: 500, color: 'rgb(74,222,128)' }}>Message sent successfully! We'll get back to you soon.</p>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    style={{ height: '48px', fontSize: '15px', color: 'rgb(255,255,255)' }}
                  />
              ...
              <div>
                <label style={{ display: 'block', fontSize: '13px', fontWeight: 500, color: 'rgba(255,255,255,0.5)', marginBottom: '6px' }}>Property Address *</label>
                <input
                  type="text"
                  ...
                  style={{ height: '48px', fontSize: '15px', color: 'rgb(255,255,255)' }}
                />
                {errors.property_address && <p style={{ fontSize: '12px', color: 'rgb(239,68,68)', marginTop: '4px' }}>{errors.property_address}</p>}
              </div>
              <div>
                <label style={{ display: 'block', fontSize: '13px', fontWeight: 500, color: 'rgba(255,255,255,0.5)', marginBottom: '6px' }}>More Details</label>
                <textarea
                  value={data.message}
              ...
              >
                {processing ? 'Sending...' : 'Contact Agent'} <ArrowRight className="w-4 h-4" />
              </button>
            </form>
          </div>
        </div>
