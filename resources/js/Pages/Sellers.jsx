    ...
    <>
          ...
          <div className="mx-auto flex flex-1 items-center px-4 sm:px-6 lg:px-[40px]" style={{ maxWidth: '1400px', width: '100%' }}>
            <div className="w-full max-w-[600px]">
              <div className="mb-6 inline-flex items-center gap-2 rounded-full px-5 py-2.5" style={{ border: '1px solid rgba(156,163,175,0.25)', background: 'rgba(255,255,255,0.06)', backdropFilter: 'blur(20px)', boxShadow: 'rgba(0,0,0,0.12) 0px 8px 32px' }}>
                ...
                <span style={{ fontSize: '13px', fontWeight: 600, letterSpacing: '1.5px', color: 'rgba(255,255,255,0.9)' }}>FOR SELLERS</span>
              </div>
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6 md:grid-cols-3 lg:grid-cols-5">
            {whyFsbo.map((item, i) => (
              <div key={i} className="rounded-2xl border border-gray-200/60 transition-all duration-300 hover:border-gray-300 hover:shadow-xl hover:-translate-y-1 relative flex flex-col items-center p-6 text-center group" style={{ background: 'rgba(255,255,255,0.65)', backdropFilter: 'blur(16px)', boxShadow: 'rgba(0,0,0,0.06) 0px 4px 24px, rgba(255,255,255,0.8) 0px 1px 0px inset' }}>
                ...
                <p style={{ fontSize: '15px', lineHeight: '24px', color: 'rgb(100,100,100)' }}>{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ backgroundColor: 'rgb(26,24,22)' }}>
        <div className="mx-auto px-4 sm:px-6 lg:px-[40px] py-16 md:py-24 text-center" style={{ maxWidth: '1400px' }}>
          ...
          <Link href="/list-property" className="inline-flex items-center justify-center gap-2 rounded-full transition-opacity hover:opacity-90" style={{ backgroundColor: 'rgb(255,255,255)', color: 'rgb(26,24,22)', height: '46px', paddingLeft: '28px', paddingRight: '28px', fontSize: '14px', fontWeight: 600 }}>List My Property <ArrowRight className="w-4 h-4" /></Link>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: 'rgb(249,250,251)' }}>
        <div className="mx-auto px-4 sm:px-6 lg:px-[40px] py-12 md:py-20" style={{ maxWidth: '1400px' }}>
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            {/* Left side */}
            <div>
              <div className="mb-4"><span style={{ fontWeight: 600, fontSize: '13px', letterSpacing: '2px', color: 'rgb(100,100,100)' }}>FAQS</span></div>
              <h2 className="text-[26px] leading-[34px] sm:text-[32px] sm:leading-[40px] lg:text-[36px] lg:leading-[44px] mb-5" style={{ fontWeight: 700, color: 'rgb(26,24,22)' }}>Frequently Asked Questions</h2>
              <p className="mb-8" style={{ fontSize: '15px', lineHeight: '26px', color: 'rgb(100,100,100)', maxWidth: '480px' }}>
      ...
      <section style={{ backgroundColor: 'rgb(255,255,255)' }}>
        <div className="mx-auto px-4 sm:px-6 lg:px-[40px] py-12 md:py-20" style={{ maxWidth: '1400px' }}>
          <div className="mb-4 text-center"><span style={{ fontWeight: 600, fontSize: '13px', letterSpacing: '2px', color: 'rgb(100,100,100)' }}>CONTACT US</span></div>
          <h2 className="mb-5 text-center text-[26px] leading-[34px] sm:text-[32px] sm:leading-[40px] lg:text-[36px] lg:leading-[44px]" style={{ fontWeight: 700, color: 'rgb(26,24,22)' }}>Do you have questions or need support?</h2>
          <p className="text-center mb-14" style={{ fontSize: '15px', lineHeight: '26px', color: 'rgb(100,100,100)', maxWidth: '600px', margin: '0 auto 56px' }}>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div className="rounded-2xl border border-gray-200/60 p-6 flex items-center gap-4" style={{ background: 'rgba(255,255,255,0.65)', backdropFilter: 'blur(16px)', boxShadow: 'rgba(0,0,0,0.06) 0px 4px 24px, rgba(255,255,255,0.8) 0px 1px 0px inset' }}>
                ...
                <div>
                  <h3 style={{ fontSize: '13px', fontWeight: 700, color: 'rgb(26,24,22)', letterSpacing: '0.5px', marginBottom: '4px' }}>PHONE</h3>
                  <a href="tel:2016960291" style={{ fontSize: '14px', color: 'rgb(100,100,100)' }}>201.696.0291</a>
                </div>
              </div>
              <div className="rounded-2xl border border-gray-200/60 p-6 flex items-center gap-4" style={{ background: 'rgba(255,255,255,0.65)', backdropFilter: 'blur(16px)', boxShadow: 'rgba(0,0,0,0.06) 0px 4px 24px, rgba(255,255,255,0.8) 0px 1px 0px inset' }}>
                <div className="flex items-center justify-center rounded-2xl flex-shrink-0" style={{ width: '56px', height: '56px', backgroundColor: 'rgb(245,245,244)' }}>
                ...
                <div>
                  <h3 style={{ fontSize: '13px', fontWeight: 700, color: 'rgb(26,24,22)', letterSpacing: '0.5px', marginBottom: '4px' }}>EMAIL</h3>
                  <a href="mailto:info@saveonyourhome.com" style={{ fontSize: '14px', color: 'rgb(100,100,100)' }}>info@saveonyourhome.com</a>
                </div>
              </div>
            </div>
