      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-4 border-t border-white/10">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="https://twitter.com/SaveOnYourHome"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#DCD8D5] hover:text-white transition-colors"
            ...
            <a
              href="https://www.youtube.com/@SaveOnYourHome"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#DCD8D5] hover:text-white transition-colors"
              aria-label="YouTube"
            ...
            <a
              href="https://www.tiktok.com/@SaveOnYourHome"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#DCD8D5] hover:text-white transition-colors"
              aria-label="TikTok"
            ...
            <a
              href="https://www.linkedin.com/company/SaveOnYourHome"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#DCD8D5] hover:text-white transition-colors"
              aria-label="LinkedIn"
